...
let store = {storeNumber: 5, locationCity: "Milan", locationCountry: "Italy", products: [banana, apple, candy]}
...
for(let product = 0;product < store.products.length;product++) {
    console.log(store.products[product]);
}

console.log('-----------------');
console.log(store.products[2]);

store.products[0] = 1.75;

console.log('-----------------');
console.log(`Store obj is:${store}`);
console.log(`Bananna obj is:${banana}`);
